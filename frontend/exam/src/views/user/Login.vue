  ...
  <div class="main">
    ...
    >
      ...
      >
        ...
        <a-tab-pane key="tab1">
          <p style="color: #40a9ff;font-size: 30px;">车载智能虚拟仿真实验平台</p>
          <p style="color: #40a9ff;" >成果来源：本平台的虚仿实验由省级科研“微观交通仿真关键技术研究及应用”项目和校级教改项目“智能网联汽车应用开发虚拟仿真实验”项目相关成果转化而来。</p>
          <p style="color: #40a9ff;" >教学任务：本平台承担包括车载应用开发基础在内的3门课程的实验教学任务.共16学时。</p>
          <p style="color: #40a9ff;" >实验项目：包含智能汽车“人-车交互”系统应用、车载系统“手机-车机”互联应用等4个具体的实验项目。</p>
          <p style="color: #40a9ff;" >课程学时：共16学时。</p>
          <div>
            <p style="color:red;">账号：test    密码：admin@123456</p>
          </div>

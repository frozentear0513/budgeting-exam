<template>
  <a-modal title="编辑参数" :width="640" :visible="visible" :confirmLoading="confirmLoading" @cancel="handleCancel">
...
export default {
  ...
  methods: {
    ...
    handleMultiChange (values) {
      ...
      for (let i = 0; i < this.question.options.length; i++) { // 遍历所有的参数的选项
        // 取出一个选项的id

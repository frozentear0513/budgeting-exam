  ...
  <a-layout>
    <a-layout-header class="header" style="color: #fff">
      ...
      <span style="float: right;">
        <span style="margin-right: 60px; font-size: 20px" v-if="examDetail.exam">实验限时：{{ examDetail.exam.examTimeLimit }}分钟 这里是倒计时</span>
      ...
      <a-layout :style="{ marginLeft: '200px' }">
        <a-layout-content :style="{ margin: '24px 16px 0',height: '84vh', overflow: 'initial' }">
          <div :style="{ padding: '24px', background: '#fff',height: '84vh'}">
            <span v-show="currentQuestion === ''" style="font-size: 30px;font-family: Consolas">欢迎参加实验，请点击左侧参数编号开始答题</span>
        ...
        <a-layout-footer :style="{ textAlign: 'center' }">
          Spting Boot Virtual test platform ©2020 Crated by Liang Shan Guang
        </a-layout-footer>
      </a-layout>
    </a-layout>
  </a-layout>

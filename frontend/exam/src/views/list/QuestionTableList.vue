    ...
    return {
      ...
      columns: [
        ...
        },
        {
          ...
          events: {
            'click .question-name': function (e, value, row, index) {
              that.$refs.questionUpdateModal.edit('summernote-question-name-update', row, 'name', '更新参数名称', questionUpdate)
            }
          }
        },
        {
          ...
          events: {
            'click .question-desc': function (e, value, row, index) {
              that.$refs.questionUpdateModal.edit('summernote-question-desc-update', row, 'description', '更新参数解析', questionUpdate)
            }
          }
        },
        {
        ...
        },
        {
          ...
          align: 'center',
          formatter: (value, row) => {
            return '<button type="button" class="btn btn-success view-question">查看</button>'
             /* '&nbsp;&nbsp;' +
